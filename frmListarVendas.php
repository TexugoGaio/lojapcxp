<?php 
    ...
    $con = open_database();
    select_database();
    $sql = "SELECT vendas.venda_id, vendas.cli_id, clientes.nome, vendas.data, vendas.valor FROM vendas INNER JOIN clientes ON vendas.cli_id=clientes.id;";
        ...
        <div class="row col-md-12">
            <table class="table table-hover table-bordered" >
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-warning" onclick="javascript:location.href='frmDetalhesVendas.php?id=' + <?php echo row['id'] ?>">
